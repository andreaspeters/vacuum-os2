...
**
** Created: Sat Jan 26 02:18:31 2013
...
static const char qt_meta_stringdata_RegisterDialog[] = {
    "RegisterDialog\0\0AId,AFields\0"
    "onRegisterFields(QString,IRegisterFields)\0"
    "AId\0onRegisterSuccessful(QString)\0"
    "AId,AError\0onRegisterError(QString,XmppError)\0"
...
int RegisterDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: onRegisterFields((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const IRegisterFields(*)>(_a[2]))); break;
        case 1: onRegisterSuccessful((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 2: onRegisterError((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const XmppError(*)>(_a[2]))); break;
