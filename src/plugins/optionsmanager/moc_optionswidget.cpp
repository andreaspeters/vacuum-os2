...
**
** Created: Sat Jan 26 01:40:33 2013
...
static const char qt_meta_stringdata_OptionsWidget[] = {
    "OptionsWidget\0\0modified()\0childApply()\0"
...
void *OptionsWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "IOptionsWidget"))
        return static_cast< IOptionsWidget*>(const_cast< OptionsWidget*>(this));
...
// SIGNAL 0
void OptionsWidget::modified()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}

// SIGNAL 1
void OptionsWidget::childApply()
{
    QMetaObject::activate(this, &staticMetaObject, 1, 0);
}

// SIGNAL 2
void OptionsWidget::childReset()
{
