...
**
** Created: Sat Jan 26 01:23:21 2013
...
static const char qt_meta_stringdata_AboutBox[] = {
    "AboutBox\0\0ALink\0onLabelLinkActivated(QString)\0"
};
...
int AboutBox::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: onLabelLinkActivated((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 1;
    }
